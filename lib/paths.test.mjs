...
describe('paths', () => {
  ...
  it('still honors ORCH_STATE_DIR overrides explicitly', async () => {
    ...
    const { STATE_DIR } = await import('./paths.mjs');
