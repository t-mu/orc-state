...
import { latestRunActivityMap, latestRunActivityDetailMap, runIdleMs } from './runActivity.mjs';
...
describe('latestRunActivityMap', () => {
  it('tracks latest relevant activity per run', () => {
    ...
    const map = latestRunActivityMap(events);
...
describe('latestRunActivityDetailMap', () => {
  it('tracks latest event and source metadata per run', () => {
    ...
    const map = latestRunActivityDetailMap(events);
