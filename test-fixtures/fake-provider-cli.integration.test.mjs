...
const fixturePath = resolve(import.meta.dirname, 'fake-provider-cli.mjs');
const fixtureBinPath = resolve(import.meta.dirname, 'bin');

function waitForLine(stream, predicate, timeoutMs = 2000) {
...
describe('test-fixtures/fake-provider-cli.mjs', () => {
