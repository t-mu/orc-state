 ...
 */
export function adapterOwnsSession(adapter, sessionHandle) {
  if (typeof adapter?.ownsSession !== 'function') return true;
  return adapter.ownsSession(sessionHandle);
}
 ...
 */
export function adapterDetectInputBlock(adapter, sessionHandle) {
  if (typeof adapter?.detectInputBlock !== 'function') return null;
  return adapter.detectInputBlock(sessionHandle);
}
