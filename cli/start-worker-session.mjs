 ...
 * Usage:
 *   node cli/start-worker-session.mjs <worker_id> --provider=<codex|claude|gemini> [--role=<worker|reviewer>] [--force-rebind]
 *
 ...
 */
import { getAgent, registerAgent, updateAgentRuntime } from '../lib/agentRegistry.mjs';
import { createAdapter } from '../adapters/index.mjs';
import { STATE_DIR } from '../lib/paths.mjs';
import { flag } from '../lib/args.mjs';
import { promptAgentId, promptProvider, promptWorkerRole } from '../lib/prompts.mjs';
